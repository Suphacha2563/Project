!function (n, t) {
    ...
    var n = {
        ...
        a = e(["success", "warning", "info", "question", "error"]), s = function (n, t) {
    ...
    var b = function (n) {
        ...
        var e = void 0, s = B(), l = "string" == typeof t.target ? document.querySelector(t.target) : t.target;
        ...
        var f = A(), m = L(), b = T(), g = N(), x = O(), h = V(), y = Y();
        if (t.titleText ? m.innerText = t.titleText : m.innerHTML = t.title.split("\n").join("<br />"), t.backdrop || X(document.body, o["no-backdrop"]), t.text || t.html) {
            if ("object" === p(t.html)) if (b.innerHTML = "", 0 in t.html) for (var v = 0; v in t.html; v++) b.appendChild(t.html[v].cloneNode(!0)); else b.appendChild(t.html.cloneNode(!0)); else t.html ? b.innerHTML = t.html : t.text && (b.textContent = t.text);
            U(b)
        } else W(b);
        ...
        var E = q(), j = parseInt(null === t.currentProgressStep ? k.getQueueStep() : t.currentProgressStep, 10);
        ...
        if ("undefined" != typeof window) {
            ...
            return new Promise(function (t, e) {
                var a = function (e) {
                    ...
                    n.closePopup(r.onClose), r.useRejections ? e(o) : t({dismiss: o})
                }, c = function (t) {
                ...
                for (var d = function (t) {
                    ...
                    var e = t || window.event, o = e.target || e.srcElement, a = O(), i = V(),
                        p = a && (a === o || a.contains(o)), w = i && (i === o || i.contains(o));
                    switch (e.type) {
                        case"mouseover":
                        case"mouseup":
                        ...
                        case"mousedown":
                            ...
                            break;
                        case"click":
                            if (p && n.isVisible()) if (n.disableButtons(), r.input) {
                                var f = function () {
                                    var n = u();
                                    if (!n) return null;
                                    switch (r.input) {
                            ...
                            } else d(!0); else w && n.isVisible() && (n.disableButtons(), l("cancel"))
                    }
                ...
                if (Y().onclick = function () {
                    ...
                    k.onmousedown = function () {
                        w.onmouseup = function (n) {
                            w.onmouseup = void 0, n.target === w && (S = !0)
                        }
                        ...
                        S ? S = !1 : n.target === w && r.allowOutsideClick && l("overlay")
                    }
                }
                var P = N(), E = O(), M = V();
                ...
                r.toast && m && (window.onkeydown = f, m = !1), r.toast || m || (f = window.onkeydown, m = !0, window.onkeydown = function (t) {
                    ...
                    if ("Enter" !== e.key || e.isComposing) if ("Tab" === e.key) {
                        for (var o = e.target || e.srcElement, a = H(r.focusCancel), s = -1, i = 0; i < a.length; i++) if (o === a[i]) {
                            s = i;
                            break
                        }
                        e.shiftKey ? K(s, -1) : K(s, 1), e.stopPropagation(), e.preventDefault()
                    } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key) ? document.activeElement === E && _(M) ? M.focus() : document.activeElement === M && _(E) && E.focus() : "Escape" !== e.key && "Esc" !== e.key || !0 !== r.allowEscapeKey || l("esc"); else if (e.target === u()) {
                    ...
                    r.showConfirmButton || (W(E), r.showCancelButton || W(N())), D(P, o.loading), D(k, o.loading), k.removeAttribute("aria-busy"), E.disabled = !1, M.disabled = !1
                }, n.getTitle = function () {
                    return L()
                ...
                for (var Q = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], F = void 0, G = 0; G < Q.length; G++) {
                    var nn = o[Q[G]], tn = $(k, nn);
                    if (F = u(Q[G])) {
                        for (var en in F.attributes) if (F.attributes.hasOwnProperty(en)) {
                            var on = F.attributes[en].name;
                            "type" !== on && "value" !== on && F.removeAttribute(on)
                        }
                        for (var an in r.inputAttributes) F.setAttribute(an, r.inputAttributes[an])
                    }
                    tn.className = nn, r.inputClass && X(tn, r.inputClass), W(tn)
                }
                var sn = void 0;
                switch (r.input) {
                    case"text":
                    ...
                    case"tel":
                    case"url":
                        (F = $(k, o.input)).value = r.inputValue, F.placeholder = r.inputPlaceholder, F.type = r.input, U(F);
                        break;
                    case"file":
                        (F = $(k, o.file)).placeholder = r.inputPlaceholder, F.type = r.input, U(F);
                        break;
                    case"range":
                        var rn = $(k, o.range), ln = rn.querySelector("input"), cn = rn.querySelector("output");
                        ln.value = r.inputValue, ln.type = r.input, cn.value = r.inputValue, U(rn);
                        break;
                    case"select":
                        var pn = $(k, o.select);
                        if (pn.innerHTML = "", r.inputPlaceholder) {
                            var un = document.createElement("option");
                            un.innerHTML = r.inputPlaceholder, un.value = "", un.disabled = !0, un.selected = !0, pn.appendChild(un)
                        }
                        sn = function (n) {
                            for (var t in n) {
                    ...
                    case"radio":
                        var dn = $(k, o.radio);
                        dn.innerHTML = "", sn = function (n) {
                            for (var t in n) {
                                var e = document.createElement("input"), a = document.createElement("label"),
                                    s = document.createElement("span");
                                e.type = "radio", e.name = o.radio, e.value = t, r.inputValue.toString() === t && (e.checked = !0), s.innerHTML = n[t], a.appendChild(e), a.appendChild(s), a.for = e.id, dn.appendChild(a)
                            }
                            U(dn);
                            var i = dn.querySelectorAll("input");
                            i.length && i[0].focus()
                        };
                        break;
                    case"checkbox":
                        var wn = $(k, o.checkbox), fn = u("checkbox");
                        fn.type = "checkbox", fn.value = 1, fn.id = o.checkbox, fn.checked = Boolean(r.inputValue);
                        var mn = wn.getElementsByTagName("span");
                        mn.length && wn.removeChild(mn[0]), (mn = document.createElement("span")).innerHTML = r.inputPlaceholder, wn.appendChild(mn), U(wn);
                        break;
                    case"textarea":
                        var bn = $(k, o.textarea);
                        bn.value = r.inputValue, bn.placeholder = r.inputPlaceholder, U(bn);
                        break;
                    case null:
                        break;
                    default:
                ...
                "select" !== r.input && "radio" !== r.input || (r.inputOptions instanceof Promise ? (n.showLoading(), r.inputOptions.then(function (t) {
                    n.hideLoading(), sn(t)
                })) : "object" === p(r.inputOptions) ? sn(r.inputOptions) : i("Unexpected type of inputOptions! Expected object or Promise, got " + p(r.inputOptions))), function (n, t, e) {
                    var a = A(), s = B();
                ...
                }(r.animation, r.onBeforeOpen, r.onOpen), r.toast || (r.allowEnterKey ? r.focusCancel && _(M) ? M.focus() : r.focusConfirm && _(E) ? E.focus() : K(-1, 1) : document.activeElement && document.activeElement.blur()), A().scrollTop = 0
            })
        }
    };
    ...
    }, k.version = "7.1.1", k.default = k, "object" === p(window._swalDefaults) && k.setDefaults(window._swalDefaults);
    var y = {previousActiveElement: null, previousBodyPadding: null}, v = function () {
            ...
            t && (t.parentNode.removeChild(t), D(document.body, o["no-backdrop"]), D(document.body, o["has-input"]), D(document.body, o["toast-shown"]));
            {
                if (!v()) {
                    ...
                    var a = B(), s = $(a, o.input), r = $(a, o.file), l = a.querySelector("." + o.range + " input"),
                        c = a.querySelector("." + o.range + " output"), p = $(a, o.select),
                        u = a.querySelector("." + o.checkbox + " input"), d = $(a, o.textarea);
        ...
        A = function () {
            ...
            for (var e = 0; e < n.childNodes.length; e++) if (R(n.childNodes[e], t)) return n.childNodes[e]
        }, U = function (n, t) {
